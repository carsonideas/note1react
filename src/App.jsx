...
function App() {
  return (
    <Router>
      <div className="antialiased text-zinc-100 bg-[#0a0a12] animated-gradient-mesh floating-orbs" style={{fontFamily: 'Inter, ui-sans-serif, system-ui, -apple-system, "Segoe UI", Roboto, Helvetica, Arial'}}>
        <BackgroundGlow />
        <Header />
