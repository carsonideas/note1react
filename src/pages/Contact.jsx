  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="page-content-wrapper">
        {/* Contact Methods */}
        <section className="section-spacing content-section px-8">
        ...
        <section className="section-spacing content-section px-8 pt-20">
        ...
        {/* CTA Section */}
        <section className="section-spacing-lg px-8 flex justify-center pt-20">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="max-w-4xl w-full mx-auto text-center rounded-3xl p-10 bg-gradient-to-br from-violet-500/10 to-indigo-600/10 shadow-xl ring-1 ring-zinc-200/20"
          >
