            ...
            <div className={`feature-card lg:col-span-2 relative overflow-hidden ring-1 ${isDark ? 'ring-white/10 bg-white/5' : 'ring-zinc-200 bg-zinc-50'} rounded-3xl p-8 backdrop-blur hover:transform hover:-translate-y-2 transition-all duration-300 hover:shadow-[0_25px_50px_-12px_rgba(139,92,246,0.25)]`}>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className={`${isDark ? 'text-zinc-300' : 'text-zinc-600'} mb-6`}>
                    End-to-end encryption ensures your notes remain private. We use industry-standard security practices to protect your data.
                  </p>
      ...
      <div className="flex flex-col rounded-2xl bg-white/5 ring-1 ring-white/10 backdrop-blur overflow-hidden">
        <div className="flex flex-col md:flex-row h-full">
          ...
          <div className="p-6 md:w-3/5">
            ...
            <p className="text-zinc-400 text-sm">
              Connect Nova with your favorite tools and workflows for a seamless experience.
            </p>
            <div className="space-y-2 mt-4">
              <div className="flex items-center gap-2 text-sm text-zinc-400">
                <div className="h-1.5 w-1.5 rounded-full bg-orange-400"></div>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className={`text-3xl sm:text-4xl font-semibold mb-4 ${isDark ? 'text-white' : 'text-zinc-900'}`}>Experience Nova in Action</h2>
            <p className={`max-w-2xl mx-auto ${isDark ? 'text-zinc-300' : 'text-zinc-600'}`}>See how Nova's powerful features can transform your workflow.</p>
          </div>
            ...
            {activeDemo === 'ai-writing' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className={`${isDark ? 'text-zinc-300' : 'text-zinc-600'} mb-6`}>
                    Let Nova's AI help you craft perfect notes, summaries, and even creative content. From grammar checks to idea generation, our AI is your intelligent co-pilot.
                  </p>
            ...
            {activeDemo === 'smart-search' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className={`${isDark ? 'text-zinc-300' : 'text-zinc-600'} mb-6`}>
                    Never lose track of an idea again. Nova's intelligent search understands context, allowing you to find notes instantly, even if you can't remember the exact keywords.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
            ...
            {activeDemo === 'backlinks' && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className={`${isDark ? 'text-zinc-300' : 'text-zinc-600'} mb-6`}>
                    Build a powerful personal knowledge graph with Nova's automatic backlinks. See how your ideas connect and discover new insights as your knowledge base grows.
                  </p>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      <div className="flex-shrink-0 h-6 w-6 rounded-full bg-purple-500/20 flex items-center justify-center mt-1">
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className={`max-w-2xl mx-auto text-base sm:text-lg ${isDark ? 'text-zinc-300' : 'text-zinc-600'}`}>
              Nova plays well with others. Connect your essential apps for a seamless workflow.
            </p>
          </div>
          ...
          <div className={`relative overflow-hidden ring-1 ${isDark ? 'ring-white/10 bg-white/5' : 'ring-zinc-200 bg-zinc-50'} rounded-3xl p-8 sm:p-16 text-center`}>
            ...
            <div className="relative z-10">
              ...
              <p className={`${isDark ? 'text-zinc-300' : 'text-zinc-600'} max-w-2xl mx-auto mb-8`}>
                Join thousands of users who are already experiencing the power of Nova. Start your free trial today!
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`relative rounded-3xl p-8 sm:p-12 overflow-hidden ${isDark ? 'bg-gradient-to-br from-violet-600 to-indigo-700' : 'bg-gradient-to-br from-violet-500 to-indigo-600'} text-white`}>
            <div className="relative z-10 text-center">
              ...
              <p className="text-lg mb-8 opacity-90">Start using Nova today and experience the future of intelligent note-taking.</p>
