  ...
  const testimonials = [
    {
      ...
      rating: 5,
      image: 'src/assets/people_images/person1.jpg'
    },
    {
      ...
      rating: 5,
      image: 'src/assets/people_images/person2.jpg'
    },
    {
      name: 'Emily Johnson',
      ...
      rating: 5,
      image: 'src/assets/people_images/person4.jpg'
    }
  ];
    ...
    <div className="min-h-screen flex">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className={isDark ? 'text-zinc-400' : 'text-zinc-600'}>
              {currentStep === 1 && "Join thousands of educators who trust Assesium with their assessments"}
      ...
      <div className={`w-1/2 relative overflow-hidden ${isDark ? 'bg-gradient-to-br from-violet-900/20 to-indigo-900/20' : 'bg-gradient-to-br from-violet-50 to-indigo-50'}`}>
        ...
        <div className="gradient-bg"></div>
              ...
              <img src={person3} alt="Prof. Rachel Kim" className="w-10 h-10 rounded-full object-cover ring-2 ring-white dark:ring-zinc-900 shadow-lg" />
        <div className="gradient-bg"></div>
